...
-- AddForeignKey
ALTER TABLE `attribute_group_link` ADD CONSTRAINT `attribute_group_link_attribute_id_fkey` FOREIGN KEY (`attribute_id`) REFERENCES `attribute`(`attribute_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `attribute_group_link` ADD CONSTRAINT `attribute_group_link_group_id_fkey` FOREIGN KEY (`group_id`) REFERENCES `attribute_group`(`attribute_group_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `attribute_option` ADD CONSTRAINT `attribute_option_attribute_id_fkey` FOREIGN KEY (`attribute_id`) REFERENCES `attribute`(`attribute_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_attribute_value_index` ADD CONSTRAINT `product_attribute_value_index_product_id_fkey` FOREIGN KEY (`product_id`) REFERENCES `product`(`product_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_attribute_value_index` ADD CONSTRAINT `product_attribute_value_index_attribute_id_fkey` FOREIGN KEY (`attribute_id`) REFERENCES `attribute`(`attribute_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
